...
namespace HeresyCore.Utilities
{
    ...
    {
        public static Dictionary<TKey, TValue> Remap<TKey, TSValue, TValue>(this IDictionary<TKey, TSValue> dict, Func<TSValue, TValue> valueConverter)
            => dict.ToDictionary(kvp => kvp.Key, kvp => valueConverter(kvp.Value));

        public static Dictionary<TKey, TValue> ToPlainDictionary<TKey, TValue>(this IDictionary<TKey, Property<TValue>> dict)
